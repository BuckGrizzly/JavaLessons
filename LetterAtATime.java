...
public class LetterAtATime
{
	public static void main( String[] args )
	{
		...
		//changing the length to <= caused an exception to occur at the end of the run
		//box is 3 characters long, the x is position # 2
		//adding the <= validates the last number which is outside of the range of the string
		//
