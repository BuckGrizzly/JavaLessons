public class HeronsFormula
{
	...
	public static double triangleArea( int a, int b, int c )
	{
		...
		//HeronsFormula and HeronsFormulaNoFunction return the same output.
		//HeronsFormula is 30 lines of code, HeronsFormulaNoFunction is 50 lines of code.
		//HeronsFormula required a 1 line code change, HeronsFormulaNoFunction required 6.
		//HeronsFormula required a 1 line code change, HeronsFormulaNoFunction required 6.
